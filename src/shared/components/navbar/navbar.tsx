...
export function NavBar() {
  ...
  return (
    <nav className="fixed top-0 z-10 flex w-full items-center justify-between bg-linear-orange-gray px-8 py-5 text-lg backdrop-blur-[100px] lg:px-12 lg:text-xl">
